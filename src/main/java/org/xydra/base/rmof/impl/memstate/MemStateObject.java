...
public class MemStateObject extends MemStateEntity implements XStateWritableObject {
    ...
    public MemStateObject(XAddress address) {
        super(address);
    ...
    @Override
    public XStateWritableField createField(XId fieldId) {
        XStateWritableField field = this.fields.get(fieldId);
        if(field != null) {
            return field;
        }
        MemStateField newField = new MemStateField(Base.resolveField(getAddress(), fieldId));
        this.fields.put(fieldId, newField);
        return newField;
    }
    
    @Override
    public XStateWritableField getField(XId fieldId) {
    ...
    public boolean removeField(XId fieldId) {
        XStateWritableField oldField = this.fields.remove(fieldId);
     ...
     */
    public static MemStateObject shallowCopy(XRevWritableObject object) {
        
        if(object == null) {
            return null;
        }
        
        MemStateObject result = new MemStateObject(object.getAddress());
    ...
    private void addField(XRevWritableField field) {
