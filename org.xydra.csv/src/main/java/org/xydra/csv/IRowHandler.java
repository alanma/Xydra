...
public interface IRowHandler {
	...
	/**
	 * @param rowName must be unique within a stream
	 * @param readableRow from which all columns listed in
	 *            {@link #handleHeaderRow(Collection)} will be used.
	 * @throws IllegalStateException if there was no
	 *             {@link #handleHeaderRow(Collection)} yet.
