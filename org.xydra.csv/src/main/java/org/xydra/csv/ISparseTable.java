...
public interface ISparseTable extends Iterable<Row>, IRowHandler {
	 ...
	 * @param create
	 *            if true, creates a new {@link Row} if there is none yet. If
	 ...
	 *            never null
	 * @param increment
	 *            the increment, often '1' is used.
	 * @throws WrongDatatypeException
	 *             if the stored value cannot be cast to a long.
	 */
	...
	/**
	 * @param aggregateStrings
	 *            Default is true. If false, strings are not aggregated.
	 */
	...
	void setValueInitial(String rowName, String columnName, long value);
