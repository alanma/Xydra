...
public interface ILoggerFactorySPI {
     ...
     * 
     * @param name the name of the {@link Logger} to return @NeverNull
     * @param logListeners @CanBeNull if not null, send all log events also to
     *            listeners
     ...
     * 
     * @param name the name of the {@link Logger} to return @NeverNull
     * @param fullyQualifiedNameOfDelegatingLoggerClass this class is filtered
     *            out from stack-traces
