...
public class NameUtils {
	...
	public static String getProductName() {
		final int a1 = (int) Math.round((ADJ.length - 1) * Math.random());
		int a2 = a1;
		while (a2 == a1) {
			a2 = (int) Math.round((ADJ.length - 1) * Math.random());
		}
		final int n1 = (int) Math.round((NOUN1.length - 1) * Math.random());
		final int n2 = (int) Math.round((NOUN2.length - 1) * Math.random());
		return
	...
	public static String getPersonName() {
		final int firstname = (int) Math.round((FIRSTNAME.length - 1) * Math.random());
		final int lastname = (int) Math.round((LASTNAME.length - 1) * Math.random());
