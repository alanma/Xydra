...
public class UrchinUrl {
	 ...
	 * @return
	 */
	public static String toURL(String hostname, FocusPoint focusPoint,
			String refererURL, UrchinCookie cookie, String trackingCode,
			GaEvent gaEvent) {
	...
	private static void appendIfNotEmpty(StringBuffer url, String key,
