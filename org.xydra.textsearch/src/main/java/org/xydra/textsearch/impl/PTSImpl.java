...
/**
 * Indexes nodes of type <V> via strings.
 * 
 * Make sure to call
 * {@link #configure(String, String, org.xydra.textsearch.PragmaticTextSearch.Normaliser)}
 * 
 * @author xamde
 * 
 * @param <V>
...
public class PTSImpl<V> implements PragmaticTextSearch<V> {
     ...
     * (non-Javadoc)
     * 
     * @see de.xam.ptextsearch.PragmaticTextSearch#configure(java.lang.String,
     * java.lang.String, de.xam.ptextsearch.PragmaticTextSearch.Normaliser)
     */
    @Override
    ...
    public Iterator<V> searchBoth(String token) {
        return new BagUnionIterator<V>(this.prefixIndex.search(token),
                this.substringIndex.search(token));
    }
