...
abstract public class AbstractSerializedEventTest extends AbstractSerializingTest {
    ...
    public void testReversibleFieldEventChange() {
        testEvent(MemoryFieldEvent.createChangeEvent(actor, field, value, 33, 23, 2,
                false));
    }
    ...
    public void testReversibleFieldEventRemove() {
        testEvent(MemoryFieldEvent.createRemoveEvent(actor, field, 33, 23, 2, false,
                false));
    }
    ...
    public void testBigTransactionEvent() {
        ...
        final XModel model = new MemoryModel(actor, "-", id);
        ...
        final Iterator<XEvent> it = model.getChangeLog().getEventsSince(0);
        while(it.hasNext()) {
            testEvent(it.next());
        }
    ...
    private void testEvent(final XEvent event) {
