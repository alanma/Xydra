...
public class AccessControlTest {
    ...
    public void testAddActors() throws Throwable {
        final XAccessControlManager acm = this.store.getXydraStoreAdmin().getAccessControlManager();
        XAuthenticationDatabase authenticationDb = acm.getAuthenticationDatabase();
        final XGroupDatabase groupDb = acm.getAuthorisationManager().getGroupDatabase();
