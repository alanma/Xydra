...
public abstract class AbstractStoreTest {
     ...
     * {@link XydraStore} returned by {@link #createStore()}.
     *
     ...
     * {@link #createStore()} and at least write-access to the returned store
     ...
     * {@link XydraStore} returned by {@link #createStore()}. This method works
     ...
     * returned by {@link #createStore()} cannot provide such a combination (for
     ...
     * returned by {@link #createStore()} cannot provide such a password hash
     * (for example if the implementation does not implement any access right
     * management)
     *
    ...
    /**
     * @return an new instance of {@link XydraStore} which is to be tested
     */
    abstract protected XydraStore createStore();
     ...
     */
    protected boolean waitOnCallback(final SynchronousCallbackWithOneResult<?> callback) {
        final int value = callback.waitOnCallback(getCallbackTimeout());
