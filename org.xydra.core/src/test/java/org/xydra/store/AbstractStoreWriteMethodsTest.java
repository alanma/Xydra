...
public abstract class AbstractStoreWriteMethodsTest extends AbstractStoreTest {
    ...
    public void testExecuteCommandsIncorrectModelCommands() {
        ...
        long revNr = executeSucceedingCommand(X.getCommandFactory().createAddObjectCommand(
                XX.resolveModel(this.repoId, modelId), objectId, true));
        ...
        // fail
        executeFailingCommand(X.getCommandFactory().createAddObjectCommand(
    ...
    public void testExecuteCommandsCorrectModelCommands() {
        ...
        executeSucceedingCommand(X.getCommandFactory().createAddObjectCommand(
                XX.resolveModel(this.repoId, modelId), objectId, true));
    ...
    public void testExecuteCommandsMixedCorrectModelCommands() {
        ...
        for(int i = 0; i < objectIds.length; i++) {
            ...
            commands[i] = X.getCommandFactory().createAddObjectCommand(
                    XX.resolveModel(this.repoId, modelId), objectIds[i], true);
        }
    ...
    public void testExecuteCommandsCorrectObjectCommands() {
        ...
        long revNr = executeSucceedingCommand(X.getCommandFactory().createAddFieldCommand(
                XX.resolveObject(this.repoId, modelId, objectId), fieldId, true));
    ...
    public void testExecuteCommandsIncorrectObjectCommands() {
        ...
        // fail
        executeFailingCommand(X.getCommandFactory().createAddFieldCommand(
    ...
    public void testExecuteCommandsMixedCorrectObjectCommands() {
        ...
        for(int i = 0; i < fieldIds.length; i++) {
            ...
            commands[i] = X.getCommandFactory().createAddFieldCommand(
                    XX.resolveObject(this.repoId, modelId, objectId), fieldIds[i], true);
        }
    ...
    public void testExecuteCommandsCorrectFieldCommands() {
        ...
        executeSucceedingCommand(X.getCommandFactory().createAddFieldCommand(
                XX.resolveObject(this.repoId, modelId, objectId), fieldId, true));
        ...
        executeSucceedingCommand(X.getCommandFactory().createAddValueCommand(
                XX.resolveField(this.repoId, modelId, objectId, fieldId), revNr, testValue, true));
        ...
        executeSucceedingCommand(X.getCommandFactory().createChangeValueCommand(
                XX.resolveField(this.repoId, modelId, objectId, fieldId), revNr, testValue2, true));
        revNr++;
    ...
    public void testExecuteCommandsIncorrectFieldCommands() {
        ...
        executeFailingCommand(X.getCommandFactory().createChangeValueCommand(
                XX.resolveField(this.repoId, modelId, objectId, fieldId), 0, testValue, false));
        
        // add a value
        long revNr = executeSucceedingCommand(X.getCommandFactory().createAddValueCommand(
                XX.resolveField(this.repoId, modelId, objectId, fieldId), XCommand.FORCED,
                testValue, true));
    ...
    public void testGetEventsFieldEventsAddType() {
        ...
        executeSucceedingCommand(X.getCommandFactory().createAddValueCommand(
                XX.resolveField(this.repoId, modelId, objectId, fieldId), fieldRev, value1, true));
    ...
    public void testGetEventsFieldEventsChangeType() {
        ...
        executeSucceedingCommand(X.getCommandFactory().createChangeValueCommand(
                XX.resolveField(this.repoId, modelId, objectId, fieldId), fieldRev, value2, true));
