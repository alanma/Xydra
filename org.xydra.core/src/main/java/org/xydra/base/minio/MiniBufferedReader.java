...
public class MiniBufferedReader extends AbstractMiniReader implements MiniReader {
	 ...
	 */
	public MiniBufferedReader(final MiniReader in, final int sz) {
		this.in = in;
		if(sz <= 0) {
	 ...
	 * @param in A Reader
	 */
	public MiniBufferedReader(final MiniReader in) {
	 ...
	 * stream if necessary.
	 */
	private int read1(final char[] cbuf, final int off, final int len) throws MiniIOException {
		if(this.nextChar >= this.nChars) {
			/*
	 ...
	 * @exception MiniIOException If an I/O error occurs
	 */
	String readLine(final boolean ignoreLF) throws MiniIOException {
		StringBuffer s = null;
		int startChar;
	 ...
	 * @exception MiniIOException If an I/O error occurs
	 */
	public long skip(final long n) throws MiniIOException {
		if(n < 0L) {
