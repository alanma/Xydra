 ...
 * 
 * TODO weird class, sometimes creates information on the fly if none is present
 */
abstract public class XValueUtils {
    
    /**
     * @param v
     * @return the empty string if v is empty
     */
    protected static Object listGetFirst(@NeverNull XListValue<?> v) {
        if(!v.isEmpty()) {
            return v.get(0);
        } else {
            return "";
