package org.xydra.server.inout;
...
public class CsvExport {
	 ...
	 * 
	 * @param model to be exported
	 * @param rowHandler export target
	 * @throws IOException from underlying I/O
	 * @throws IllegalStateException if no header row has been sent
	 */
	...
	/**
	 * @param r expect a valid, complete CSV data stream and add it to the given
	 *            repository
	 * @param repository should be empty
