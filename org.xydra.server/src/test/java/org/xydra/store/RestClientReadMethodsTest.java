 ...
 * 
 */
public class RestClientReadMethodsTest extends AbstractStoreReadMethodsTest {
	
	private static final String PASSWORD_TESTER = "secret";
	
	private static final XID ACTOR_TESTER = XX.toId("tester");
	
	private static final Logger log = LoggerFactory.getLogger(RestClientReadMethodsTest.class);
