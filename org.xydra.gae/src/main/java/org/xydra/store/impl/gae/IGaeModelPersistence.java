...
public interface IGaeModelPersistence {
	...
	/**
	 * See
	 * {@link XydraPersistence#getModelSnapshot(org.xydra.store.GetWithAddressRequest)}
	 * 
	...
	/**
	 * See
	 * {@link XydraPersistence#getObjectSnapshot(org.xydra.store.GetWithAddressRequest)}
	 * 
	 * @param objectId
	 * @param includeTentative
	 * @return ..
	...
	/**
	 * See
	 * {@link XydraPersistence#getModelRevision(org.xydra.store.GetWithAddressRequest)}
	 * 
