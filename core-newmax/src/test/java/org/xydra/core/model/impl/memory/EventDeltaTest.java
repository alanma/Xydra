...
public class EventDeltaTest {
    ...
    private void setUp() {
        ...
        this.model = remoteRepo.createModel(this.modelId);
    ...
    public void testWithNewDemoData() {
        ...
        // remove and re-add phonebook model in remote repo TODO why?
        remoteRepo.removeModel(DemoModelUtil.PHONEBOOK_ID);
        DemoModelUtil.addPhonebookModel(remoteRepo);
        
        XEvent[] serverEvents = new XEvent[count];
        // TODO why *apply* same changes again?
