...
public abstract class AbstractPersistenceTestForAtomicCommandsAndMiscellaneous {
	...
	private static final Logger log = LoggerFactory.getLogger(AbstractPersistenceTestForAtomicCommandsAndMiscellaneous.class);
	...
	public void testCompleteEntityTreeTransactionForRightRevisionNumbers() {
		...
		long executeCommand = this.persistence.executeCommand(this.actorId, transaction);
