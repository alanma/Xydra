 ...
 * 
 * TODO SECURITY Clarify behaviour (when delayed how much, when blocked, how to
 * unblock, ...)
 * 
...
public interface XydraStore {
     ...
     * {@link #getEvents(XId, String, GetEventsRequest[], Callback)}.
     * 
     * First, the commands are executed in a blocking fashion and then all
     * requested events are returned. The events include the results of
     ...
     * 
     *            TODO API How can a client request a specific version of a
     *            snapshot?
     * 
     * @param callback Asynchronous callback to signal success or failure. On
