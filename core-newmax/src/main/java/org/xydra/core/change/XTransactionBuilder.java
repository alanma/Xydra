...
public class XTransactionBuilder implements Iterable<XAtomicCommand> {
    ...
    private void assertCommandIsInTransactionScope(XCommand command) {
    ...
    public void addModel(XAddress repoAddress, long revision, XId objectId) {
        ...
        addCommand(MemoryRepositoryCommand.createAddCommand(repoAddress, revision, objectId));
    }
     ...
     */
    public void removeModel(XAddress repoAddr, long revision, XId modelId) {
