 ...
 * @author Kaidel
 */
public class OldMemoryField

// extends AbstractMOFEntity implements XField, IMemoryField,
// Serializable, Synchronizable

{
    ...
    // * @param eventQueue the {@link MemoryEventQueue} this MemoryField will
    // use; @NeverNull
    ...
    // */
    // protected OldMemoryField(OldIMemoryObject father, MemoryEventQueue
    // eventQueue,
    ...
    // throw new
    // IllegalArgumentException("must load field through containing object");
    // }
    // this.father = father;
    // }
    //
    ...
    // public OldMemoryField(XId actorId, XId fieldId) {
    ...
    // */
    // public OldMemoryField(XId actorId, XRevWritableField fieldState) {
    ...
    // }
    //
    // if(!command.isForced() && this.getRevisionNumber() !=
    ...
    //
    // } else {
    // throw new IllegalArgumentException("Unknown field command type: " +
    // command);
    // }
    //
    ...
    // "A standalone MemoryField can't be synchronized.";
    //
    // /*
    ...
    // * @param changeListener The {@link XFieldEventListener} which is to be
    // * removed
    // * @return true, if the given {@link XFieldEventListener} was registered
    // on
    ...
    // changeListener) {
    // return getRoot().removeListenerForFieldEvents(getAddress(),
    // changeListener);
    // }
    //
    // // implement IMemoryField
    ...
    // if(this.father != null) {
    // throw new
    // IllegalStateException("cannot set actor on field with a parent");
    // }
    ...
    // if(newValue == null) {
    // command = MemoryFieldCommand.createRemoveCommand(getAddress(),
    // XCommand.FORCED);
    // } else {
    // command = MemoryFieldCommand.createAddCommand(getAddress(),
    // XCommand.FORCED, newValue);
    // }
    //
    ...
    // event = MemoryReversibleFieldEvent.createAddEvent(actorId, getAddress(),
    // newValue,
    // modelRev, objectRev, fieldRev, inTrans);
    // } else {
    // if(newValue == null) {
    // // implies remove
    // event = MemoryReversibleFieldEvent.createRemoveEvent(actorId,
    // getAddress(),
    // oldValue, modelRev + 1, objectRev + 1, fieldRev + 1, inTrans, false);
    // } else {
    // XyAssert.xyAssert(!newValue.equals(oldValue));
    // // implies change
    // event = MemoryReversibleFieldEvent.createChangeEvent(actorId,
    // getAddress(),
