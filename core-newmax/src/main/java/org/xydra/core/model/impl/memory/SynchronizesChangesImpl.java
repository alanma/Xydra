...
abstract class SynchronizesChangesImpl extends AbstractEntity implements IHasXAddress,
    ...
    // LoggerFactory.getLogger(SynchronizesChangesImpl.class);
    //
    ...
    //
    // private final Set<XFieldSyncEventListener>
    // fieldSyncChangeListenerCollection;
    //
    // /** Has this entity been removed? Aka: non-existant */
    // protected boolean isRemoved = false;
    //
    // private final Set<XObjectEventListener> objectChangeListenerCollection;
    //
    // private final Set<XObjectSyncEventListener>
    // objectSyncChangeListenerCollection;
    //
    // private final Set<XTransactionEventListener>
    // transactionListenerCollection;
    //
    // SynchronizesChangesImpl(MemoryEventManager queue) {
    // this.eventQueue = queue;
    // this.objectChangeListenerCollection = new
    // HashSet<XObjectEventListener>();
    // this.fieldChangeListenerCollection = new HashSet<XFieldEventListener>();
    // this.transactionListenerCollection = new
    // HashSet<XTransactionEventListener>();
    // this.objectSyncChangeListenerCollection = new
    // HashSet<XObjectSyncEventListener>();
    // this.fieldSyncChangeListenerCollection = new
    // HashSet<XFieldSyncEventListener>();
    // }
    //
    // @Override
    // public boolean addListenerForFieldEvents(XFieldEventListener
    // changeListener) {
    ...
    //
    // @Override
    // public boolean addListenerForFieldSyncEvents(XFieldSyncEventListener
    // syncListener) {
    // synchronized(this.eventQueue) {
    ...
    //
    // @Override
    // public boolean addListenerForObjectEvents(XObjectEventListener
    // changeListener) {
    // synchronized(this.eventQueue) {
    ...
    //
    // @Override
    // public boolean addListenerForObjectSyncEvents(XObjectSyncEventListener
    // syncListener) {
    // synchronized(this.eventQueue) {
    ...
    //
    // @Override
    // public boolean addListenerForTransactionEvents(XTransactionEventListener
    // changeListener) {
    // synchronized(this.eventQueue) {
    ...
    // */
    // protected abstract void assertThisEntityIsNotRemoved() throws
    ...
    // */
    // protected abstract void assertCanBeSynced() throws IllegalStateException;
    //
    ...
    // *
    // * The caller is responsible for handling synchronization, for checking
    // that
    // * this model has not been removed and for checking that the object
    // doesn't
    // * already exist.
    // */
    // protected abstract MemoryObject createObjectInternal(XId objectId);
    //
    // protected long executeTransaction(XTransaction transaction,
    // XLocalChangeCallback callback) {
    // synchronized(this.eventQueue) {
    // assertThisEntityIsNotRemoved();
    //
    // assert !this.eventQueue.transactionInProgess :
    // "double transaction detected";
    //
    ...
    //
    // this.eventQueue.createTransactionEvent(getSessionActor(), getModel(),
    // getObject(),
    // since);
    //
    // // new objects
    ...
    // "should have existed already and not been removed";
    //
    ...
    //
    // } else {
    // assert getCurrentRevisionNumber() == oldRev + 1 :
    // "there should have been exactly one change";
    // }
    //
    // return oldRev + 1;
    // }
    ...
    // for(XFieldSyncEventListener listener :
    // this.fieldSyncChangeListenerCollection) {
    ...
    // for(XObjectSyncEventListener listener :
    // this.objectSyncChangeListenerCollection) {
    // listener.onSynced(event);
    // }
    // }
    //
    ...
    // *
    // * @param event The {@link XTransactonEvent} which will be propagated to
    // the
    // * registered listeners.
    // */
    // protected void fireTransactionEvent(XTransactionEvent event) {
    // for(XTransactionEventListener listener :
    // this.transactionListenerCollection) {
    // listener.onChangeEvent(event);
    // }
    // }
    //
    ...
    // *
    // * If the entity this method is called on already is an {@link
    // MemoryObject}
    // * the method returns this entity exactly when the given {@link XId}
    // matches
    ...
    //
    // @Override
    // public boolean removeListenerForFieldEvents(XFieldEventListener
    // changeListener) {
    // synchronized(this.eventQueue) {
    ...
    //
    // @Override
    // public boolean removeListenerForFieldSyncEvents(XFieldSyncEventListener
    // syncListener) {
    // synchronized(this.eventQueue) {
    ...
    //
    // @Override
    // public boolean removeListenerForObjectEvents(XObjectEventListener
    // changeListener) {
    // synchronized(this.eventQueue) {
    ...
    //
    // @Override
    // public boolean removeListenerForObjectSyncEvents(XObjectSyncEventListener
    // syncListener) {
    // synchronized(this.eventQueue) {
    ...
    // @Override
    // public boolean
    // removeListenerForTransactionEvents(XTransactionEventListener
    // changeListener) {
    // synchronized(this.eventQueue) {
    ...
    // MemoryRepositoryEvent.createAddEvent(getSessionActor(),
    ...
    // return XCommand.FAILED;
    // }
    // if(!rc.isForced() && getCurrentRevisionNumber() !=
    // rc.getRevisionNumber()) {
    // return XCommand.FAILED;
    // }
    //
    // int since = this.eventQueue.getNextPosition();
    ...
    // }
    //
    // XyAssert.xyAssert(getModel().getRevisionNumber() ==
    ...
    // "event %s should not be in a txn", event);
    //
    // while(getChangeLog().getCurrentRevisionNumber() <
    // event.getOldModelRevision()) {
    // this.eventQueue.logNullEvent();
    // }
    //
    // long oldModelRev = getModel() == null ? -1 :
    // getModel().getRevisionNumber();
    ...
    // XyAssert.xyAssert(event.equals(newEvent), "should be equal", event,
    // newEvent);
    // assert getModel() == null ? getObject().getRevisionNumber() ==
    // event.getRevisionNumber()
    // : getModel().getRevisionNumber() == event.getRevisionNumber();
    // XyAssert.xyAssert(getCurrentRevisionNumber() ==
    // event.getRevisionNumber());
    //
    // XyAssert.xyAssert(event.getChangedEntity().getObject() == null
    // || getObject(event.getChangedEntity().getObject()) == null
    // || getObject(event.getChangedEntity().getObject()).getRevisionNumber() ==
    // event
    // .getRevisionNumber());
    //
    // return true;
    ...
    //
    // if(revision < -1) {
    // throw new IllegalArgumentException("invalid revision number: " +
    // revision);
    // }
    //
    // synchronized(this.eventQueue) {
    ...
    //
    // /**
    // * Rolls back the changes represented by the given {@link XAtomicEvent}
    // and
    ...
    // XyAssert.xyAssert(this.isRemoved == true);
    // this.isRemoved = false;
    // } else {
    // XyAssert.xyAssert(event.getChangeType() == ChangeType.ADD);
    // XyAssert.xyAssert(this.isRemoved == false);
    ...
    // XyAssert.xyAssert(event.getChangeType() == ChangeType.ADD);
    // XyAssert.xyAssert(getModel().hasObject(objectId));
    // XyAssert.xyAssert(event.getRevisionNumber() ==
    // getModel().getObject(objectId)
    // .getRevisionNumber()
    ...
    //
    // } else {
    // XyAssert.xyAssert(event instanceof XObjectEvent || event instanceof
    // XFieldEvent);
    ...
    // MemoryField field =
    // object.getField(((XReversibleFieldEvent)event).getFieldId());
    ...
    // */
    // protected abstract void setRevisionNumberIfModel(long
    // modelRevisionNumber);
    //
    // @Override
    ...
    // XyAssert.xyAssert(!this.eventQueue.transactionInProgess);
    //
    // boolean oldRemoved = this.isRemoved;
    //
    // List<MemoryLocalChange> localChanges = this.eventQueue.getLocalChanges();
    //
    // log.info("sync: merging " + remoteChanges.length + " remote and " +
    // localChanges.size()
    // + " local changes, local rev is " + getCurrentRevisionNumber() +
    // " (synced to "
    ...
    // removedChanged = (oldRemoved != this.isRemoved && model != null &&
    // model.getFather() != null);
    // if(!removedChanged) {
    // this.eventQueue.sendEvents();
