...
public interface IConfig {
	 ...
	 * @param value
	 * @param initial
	 *            is true, when you set the value initially. If another default
	 *            value was already set, you get an {@link ConfigException}. If
	 *            you set initial to false, silent overwrite mode is active.
	 * @return a {@link ConfBuilder} for a fluent API style
	 */
	 ...
	 *            @NeverNull
	 * @param type
	 *            @NeverNull The expected type of a config key. Currently a
	 ...
	 *            @NeverNull
	 * @param values
	 *            may not contain pipe symbol '|', may not be null
	 * @return a {@link ConfBuilder} for a fluent API style
	 */
