...
import de.xam.xindex.index.IMapMapMapIndex;
				...
				public void remove() {
					...
					if(this.last != null) {
						FastTripleMap.this.idx_k2_k3_k1.deIndex(this.last.getKey2(), this.last
						        .getKey3(), this.last.getKey1());
						FastTripleMap.this.idx_k3_k1_k2.deIndex(this.last.getKey3(), this.last
						        .getKey1(), this.last.getKey2());
					}
				}
				...
				public void remove() {
					...
					if(this.last != null) {
						FastTripleMap.this.idx_k1_k2_k3.deIndex(this.last.getKey3(), this.last
						        .getKey1(), this.last.getKey2());
						FastTripleMap.this.idx_k3_k1_k2.deIndex(this.last.getKey2(), this.last
						        .getKey3(), this.last.getKey1());
					}
				}
			...
			public void remove() {
				...
				if(this.last != null) {
					FastTripleMap.this.idx_k1_k2_k3.deIndex(this.last.getKey2(), this.last
					        .getKey3(), this.last.getKey1());
					FastTripleMap.this.idx_k2_k3_k1.deIndex(this.last.getKey3(), this.last
					        .getKey1(), this.last.getKey2());
				}
			}
	...
	private Object readResolve() {
		if(this.idx_k2_k3_k1 == null) {
			...
			while(it.hasNext()) {
				...
				this.idx_k2_k3_k1.index(tuple.getKey2(), tuple.getKey3(), tuple.getKey1(), tuple
				        .getEntry());
			}
		}
		if(this.idx_k3_k1_k2 == null) {
			...
			while(it.hasNext()) {
				KeyKeyKeyEntryTuple<K,L,M,E> tuple = it.next();
				this.idx_k3_k1_k2.index(tuple.getKey3(), tuple.getKey1(), tuple.getKey2(), tuple
				        .getEntry());
			}
		}
		return this;
