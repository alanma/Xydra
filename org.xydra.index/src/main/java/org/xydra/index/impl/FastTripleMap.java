 ...
 * @param <E> entry
 */
public class FastTripleMap<K extends Serializable, L extends Serializable, M extends Serializable, E extends Serializable>
	...
	public Iterator<KeyKeyKeyEntryTuple<K, L, M, E>> tupleIterator(final Constraint<K> c1, final Constraint<L> c2,
		...
		if (c2.isStar() ? c3.isStar() : !c1.isStar()) {
			...
			return new Iterator<KeyKeyKeyEntryTuple<K, L, M, E>>() {
				...
				public void remove() {
					it.remove();
					if (this.last != null) {
						FastTripleMap.this.idx_k2_k3_k1.deIndex(this.last.getKey2(), this.last.getKey3(),
								this.last.getKey1());
						FastTripleMap.this.idx_k3_k1_k2.deIndex(this.last.getKey3(), this.last.getKey1(),
								this.last.getKey2());
					}
				}
		...
		if (!c2.isStar()) {
			...
			return new Iterator<KeyKeyKeyEntryTuple<K, L, M, E>>() {
				...
				public void remove() {
					it.remove();
					if (this.last != null) {
						FastTripleMap.this.idx_k1_k2_k3.deIndex(this.last.getKey3(), this.last.getKey1(),
								this.last.getKey2());
						FastTripleMap.this.idx_k3_k1_k2.deIndex(this.last.getKey2(), this.last.getKey3(),
								this.last.getKey1());
					}
				}
		...
		return new Iterator<KeyKeyKeyEntryTuple<K, L, M, E>>() {
			...
			public void remove() {
				it.remove();
				if (this.last != null) {
					FastTripleMap.this.idx_k1_k2_k3.deIndex(this.last.getKey2(), this.last.getKey3(),
							this.last.getKey1());
					FastTripleMap.this.idx_k2_k3_k1.deIndex(this.last.getKey3(), this.last.getKey1(),
							this.last.getKey2());
				}
			}
