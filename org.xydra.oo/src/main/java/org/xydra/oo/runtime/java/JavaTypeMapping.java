...
public class JavaTypeMapping {
     ...
     * 
     * @param javaBaseType Mapping from this Java type @NeverNull
     * @param javaComponentType potentially with a component type @NeverNull
     * @param xydraBaseValueType @NeverNull
     * @param mapper @NeverNull
     * @param factory @NeverNull
     */
     ...
     * @param javaBaseType Mapping from this Java type @NeverNull
     * @param xydraBaseValueType @NeverNull
     * @param mapper @NeverNull for Xydra types
     */
